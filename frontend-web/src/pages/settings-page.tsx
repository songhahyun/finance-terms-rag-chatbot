...
import { MAX_RETRIEVAL_TOP_K, clampTopK, loadRetrievalSettings, saveRetrievalSettings, type SearchMode } from "@/lib/retrieval-settings";

export function SettingsPage(): JSX.Element {
  const [settings, setSettings] = useState(() => loadRetrievalSettings());
